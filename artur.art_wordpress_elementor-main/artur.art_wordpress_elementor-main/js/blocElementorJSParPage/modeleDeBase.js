...
*
*
* A) Fonctionnalités importantes implémentées :
* 1)
* 2)
* 3)
*
...
*
*
* C) Fonctionnalités à modifier (voir la fin du document)
*
*
* D) Bugs à corriger (voir la fin du document)
*  Il doit y avoir des commentaires aux lignes indiquées
*
*
*
...
/* ÉCOUTEURS LIÉS AUX ÉVÉNEMENTS DE LA PAGE
* - Toujours utiliser des écouteurs d'événements déclarés ici
*/
...
/*
* Bugs à corriger écrire les numéros des lignes où qqchs doit être fait
* -
* -
* -
* -
...
/*
* Fonctionnalité à modifier écrire les numéros des lignes et la modification
* -
* -
* -
* -
